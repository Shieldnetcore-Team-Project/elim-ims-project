...
import { Plus, Trash2, Ban, Check, X, Pencil, Droplet } from "lucide-react";
...
// "nylon" is kept in the type (and in the DB's sheet_type check constraint)
// for old data/back-compat, but only Water Factory exists now, so the
// nylon-specific costing form has been removed — this route only ever
// creates "water" sheets.
        ...
        <div className="space-y-4">
          ...
          <div className="rounded-lg border p-3 space-y-3">
            ...
            <p className="text-xs text-muted-foreground">
              Preform cost/pc = (kg used Ã— cost/kg) Ã· batch yield = {money(preformCostPerPc)}
            </p>
          </div>
          ...
          <div className="grid grid-cols-3 gap-3">
            ...
            <div className="space-y-2">
              <Label>Shrink wrapper (â‚¦/carton)</Label>
              <MoneyInput
