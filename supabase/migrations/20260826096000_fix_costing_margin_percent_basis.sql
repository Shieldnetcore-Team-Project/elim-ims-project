-- ============================================================================
-- FIX: costing_price_options.margin_percent basis
-- ----------------------------------------------------------------------------
-- The water/nylon worksheets this module automates (see
-- 20260816104000_costing_calculator_dual_control_schema.sql) express margin
-- percent as margin ÷ cost of production (e.g. Black Nylon: margin ₦7,803.50
-- on a ₦19,196.50 cost of production = 41%), not margin ÷ proposed selling
-- price. submit_costing_sheet/update_costing_sheet computed it against the
-- proposed price instead, which understates the figure the worksheets report
-- (28.9% vs 41% in that example). Recompute against cost_per_pack.
-- ============================================================================
