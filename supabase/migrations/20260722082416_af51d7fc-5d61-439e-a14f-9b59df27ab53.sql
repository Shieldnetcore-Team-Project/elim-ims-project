...
BEGIN
  ...
  VALUES (v_factory, v_invoice, CURRENT_DATE, v_customer, v_customer_name, v_customer_phone, v_customer_address,
...
-- Record customer payment (applies to a debt or standalone receipt)
